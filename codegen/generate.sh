...
java -jar openapi-generator-cli.jar generate -i simplekpi_spec_openapi_v3.0.0.json -g go -o simplekpi --package-name simplekpi
...
echo "\n\nfunc (apiClient *APIClient) HTTPClient() *http.Client { return apiClient.cfg.HTTPClient }" >> simplekpi/client.go
gofmt -s -w simplekpi/*.go
